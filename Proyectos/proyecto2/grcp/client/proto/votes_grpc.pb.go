...
const (
	VoteService_TakeVote_FullMethodName = "/confproto.VoteService/TakeVote"
)
...
type VoteServiceClient interface {
	TakeVote(ctx context.Context, in *Vote, opts ...grpc.CallOption) (*VoteResponse, error)
}
...
func (c *voteServiceClient) TakeVote(ctx context.Context, in *Vote, opts ...grpc.CallOption) (*VoteResponse, error) {
	out := new(VoteResponse)
	err := c.cc.Invoke(ctx, VoteService_TakeVote_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VoteServiceServer interface {
	TakeVote(context.Context, *Vote) (*VoteResponse, error)
...
func (UnimplementedVoteServiceServer) TakeVote(context.Context, *Vote) (*VoteResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TakeVote not implemented")
}
...
func _VoteService_TakeVote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Vote)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VoteServiceServer).TakeVote(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VoteService_TakeVote_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VoteServiceServer).TakeVote(ctx, req.(*Vote))
	}
...
var VoteService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "confproto.VoteService",
	HandlerType: (*VoteServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "TakeVote",
			Handler:    _VoteService_TakeVote_Handler,
		},
	},
